                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <a href="{{route('admin.add_slide')}}" class="btn btn-info pull-right">Add
                                                New</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$slide->id}}</td>
                                                <td><img src="{{asset('images/slider')}}/{{$slide->image}}"
                                                        width="60"></td>
                                                <td>{{$slide->title}}</td>
                                                <td>
                                                    @if ($slide->status)
                                                ...
                                                <td>
                                                    <a
                                                        href="{{route('admin.edit_slide', ['slide_id'=>$slide->id])}}"><i
