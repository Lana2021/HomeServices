                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" wire:submit.prevent='updateService'>
                                        ...
                                        <div class="form-group">
                                            <label for="newthumbnail" class="control-label col-sm-3">
                                                Thumbnail:</label>
                                            <div class="col-sm-9">
                                                <input type="file" class="form-control-file" name="newthumbnail"
                                        ...
                                        <div class="form-group">
                                            <label for="newimage" class="control-label col-sm-3">
                                                Image:</label>
                                            <div class="col-sm-9">
