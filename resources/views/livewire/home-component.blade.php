    ...
    <section class="tp-banner-container">
        ...
        <div class="filter-title">
            ...
            <div class="filter-header">
                <form id="sform" action="{{route('searchService')}}" method="get">
                    @csrf
                ...
                <div class="container">
                    ...
                    <div class="portfolioContainer" style="margin-top: -50px;">
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-3 hsgrids" style="padding-right: 5px;padding-left: 5px;">
                            <a class="g-list"
                                href="{{route('home.service_details', ['service_slug'=> $fservice->slug])}}">
                                <div class="img-hover">
                                    <img src="{{asset('images/services/thumbnails')}}/{{$fservice->thumbnail}}"
                                        alt="{{$fservice->name}}" class="img-responsive">
                                </div>
                ...
                <div>
                    <a class="g-list" href="{{route('home.service_details', ['service_slug'=> $aservice->slug])}}">
                        ...
                        <div class="info-gallery">
                            ...
                            <div class="content-btn"><a
                                    href="{{route('home.service_details', ['service_slug'=> $aservice->slug])}}"
