                        ...
                        <div class="col-md-4">
                            <aside>
                                ...
                                <address>
                                    ...
                                    <i class="fa fa-map-marker"></i><strong>Address: </strong>Mostar,
                                    BiH<br>
                                    <i class="fa fa-phone"></i><strong>Phone: </strong> +387 63 654 185
                                </address>
                                <address>
                                    <strong>SurfsideMedia Emails</strong><br>
                                    <i class="fa fa-envelope"></i><strong>Email:</strong><a
                                        href="mailto:contact@surfsidemedia.in"> contact@homeservices.in</a><br>
                                    <i class="fa fa-envelope"></i><strong>Email:</strong><a
                                        href="mailto:support@surfsidemedia.in"> support@homeservices.in</a>
                                </address>
                            </aside>
                            <hr class="tall">
                        </div>
