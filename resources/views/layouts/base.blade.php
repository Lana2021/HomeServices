...
<body>
    <div id="layout">
        ...
        {{-- Toast message --}}
        <div class="notification-box hidden toast-container text-center"
            style="position: fixed; top: 0; right: 0; min-width:300px; min-height: 100px; color:white; background-color:#10cf76;"
            id="toast-container">
        </div>
                ...
                <div class="row visible-md visible-lg">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul class="contact_footer">
                            <li class="location">
                                <i class="fa fa-map-marker"></i> <a href="#"> Mostar, BiH</a>
                            </li>
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:contact@surfsidemedia.in">contact@homeservices.in</a>
                            </li>
                            <li>
                                <i class="fa fa-headphones"></i> <a href="tel:+911234567890">+387 63 584 751</a>
                            </li>
                        </ul>
                ...
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="contact_footer mlist">
                            ...
                            <li>
                                <i class="fa fa-phone"></i> <a href="tel:+911234567890">+387 63 584 751</a>
                            </li>
                        </ul>
            ...
            <div class="footer-down">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-xs-center crtext">&copy; 2021 HomeServices. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        connection.onmessage = function (message) {
            ...
            $(".notification-box").html(notificationMessage);
