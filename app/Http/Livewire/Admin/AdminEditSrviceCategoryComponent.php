...
class AdminEditSrviceCategoryComponent extends Component
{
    use WithFileUploads;
    ...
    public function updateServiceCategory()
    {
        ...
        $this->dispatchBrowserEvent('event-notification', [
            'eventName' => 'Success',
            'eventMessage' => 'You have successfully updated service category!',
        ]);
    }

    public function render()
    {
        return view('livewire.admin.admin-edit-srvice-category-component')->layout('layouts.base');
    }
}
