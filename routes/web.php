...
use App\Http\Livewire\Admin\AdminEditSrviceCategoryComponent;
...
Route::middleware([
    ...
    Route::get('/admin/service-category/edit/{category_id}', AdminEditSrviceCategoryComponent::class)->name('admin.edit_service_category');
